...
switch ($_GET['accion']) {
  case 'agregar':
    ...
    $respuesta = mysqli_query($conexion, "insert into usuarios(usuario,clave) values ('$nombre','$clave')");
    echo json_encode($respuesta);
    break;
  case 'existe':
    $nombre = mysqli_real_escape_string($conexion, $_POST['nombrenuevo']);
    $respuesta = mysqli_query($conexion, "select usuario from usuarios where usuario='$nombre'");
